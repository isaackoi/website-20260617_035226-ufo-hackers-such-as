...
show_ads: true
description: The cigar-shaped object is memorable, but McKinnon's own description leaves open satellites, artifacts, and ordinary aerospace explanations.
hero_summary: The cigar-shaped object is memorable, but McKinnon's own description leaves open satellites, artifacts, and ordinary aerospace explanations.
layout: default
permalink: /cigar-object/
sidebar_expanded_urls:
- /ufo-hackers-such/
- /nasa-claims/
nav_short_title: Cigar Object
title: Was The Cigar Shaped Object Really A UFO?
title_full: Was The Cigar Shaped Object Really A UFO?
display_title_short: Cigar Object
display_title: Cigar Object
heading_title: Was The Cigar Shaped Object Really A UFO?
page_heading_title: Was The Cigar Shaped Object Really A UFO?
source_count: 22
infographic_count: 3
planned_sections:
- The object Mc Kinnon described
- Why size and location matter
- Conventional explanations that cannot be ruled out
...
next_link:
  ...
  heading_title: Why The Missing Image Matters So Much
header:
  og_image: /assets/images/ufo_hackers_such_as_e2dece_mckinnon_nasa_claims_179b01_cigar_object_explana_6c68e0-Illustration-1-social.jpg
  preview_image: /assets/images/ufo_hackers_such_as_e2dece_mckinnon_nasa_claims_179b01_cigar_object_explana_6c68e0-Illustration-1.webp
image: /assets/images/ufo_hackers_such_as_e2dece_mckinnon_nasa_claims_179b01_cigar_object_explana_6c68e0-Illustration-1-social.jpg
---
...
The image has never been publicly produced, independently verified, or subjected to forensic analysis. As a result, the central question is not whether the object looked unusual to McKinnon—it clearly did—but whether the available information is sufficient to conclude that it was an unknown craft. The answer is no. The description is intriguing, but it leaves open a wide range of conventional [explanations]({{ 'explanations/' | relative_url }}) that cannot be eliminated.
...
* An imaging artefact.
* A partially rendered image viewed through a degraded remote connection.

</div>

The description is therefore evidence of what McKinnon believed he saw, not evidence of what the object actually was.

## The Object McKinnon Described
...
* Geometric misinterpretations when only part of an image has loaded.

</div>

A shape that appears smooth, metallic, or unusual under those conditions may not accurately reflect the source image.
...
The absence of scale is one of the biggest obstacles to interpretation.
...
1. A satellite photograph showing a large orbital vehicle hundreds of metres long.
2. A photograph of a much smaller satellite component near the camera.
3. A close-up image of hardware undergoing testing or assembly.
...
The strongest criticism of the UFO interpretation is not that a mundane explanation has been proven. Rather, it is that many ordinary explanations remain plausible.

### Satellite or Spacecraft Hardware

NASA and other space agencies routinely photograph satellites, modules, antenna structures, fuel tanks, docking equipment, and experimental hardware. Depending on viewing angle and lighting conditions, elongated spacecraft components can appear smooth and featureless.

Without scale or context, a satellite bus, upper-stage component, or other orbital hardware could potentially resemble a cigar-shaped object.
...
A particularly important possibility is incomplete rendering.
...
NASA archives contain imagery of launch systems, spacecraft testing, orbital operations, and engineering projects. Many aerospace structures look unfamiliar outside their normal context.

A viewer expecting to encounter evidence of [hidden technology]({{ 'hidden-tech/' | relative_url }}) may naturally focus on features that appear anomalous while lacking the surrounding information needed for identification.


<img src="{{ "/assets/images/ufo_hackers_such_as_e2dece_mckinnon_nasa_claims_179b01_cigar_object_explana_6c68e0-Illustration-3-dark.svg" | relative_url }}" alt="Cigar Object illustration 3" data-theme-src-dark="{{ "/assets/images/ufo_hackers_such_as_e2dece_mckinnon_nasa_claims_179b01_cigar_object_explana_6c68e0-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/ufo_hackers_such_as_e2dece_mckinnon_nasa_claims_179b01_cigar_object_explana_6c68e0-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What Would Be Needed To Strengthen The Claim?

The evidential weakness of the cigar-object story stems from the lack of verifiable data.

Investigators would ideally need:


<div class="content-enhancement content-enhancement--phrase-pills" markdown="1">

* The original image file.
* Metadata identifying date and source.
* Sensor information.
* Image-processing history.
* Independent expert analysis.
* Confirmation from additional witnesses.
...
## Why The Story Remains Unresolved
