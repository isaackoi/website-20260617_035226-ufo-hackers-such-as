...
show_ads: true
description: References to transfers between named vessels sound dramatic but have several ordinary explanations.
hero_summary: References to transfers between named vessels sound dramatic but have several ordinary explanations.
layout: default
permalink: /ship-transfers/
sidebar_expanded_urls:
- /ufo-hackers-such/
- /secret-fleets/
nav_short_title: Ship Transfers
title: Do Ship Transfers Mean Spacecraft Transfers?
title_full: Do Ship Transfers Mean Spacecraft Transfers?
display_title_short: Ship Transfers
display_title: Ship Transfers
heading_title: Do Ship Transfers Mean Spacecraft Transfers?
page_heading_title: Do Ship Transfers Mean Spacecraft Transfers?
source_count: 35
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Solar Warden
  heading_title: Did Solar Warden Grow From One Spreadsheet Claim?
date: '2026-06-17 01:43:48 '
header:
  og_image: /assets/images/ufo_hackers_such_as_e2dece_secret_space_fleets_d01cca_ship_transfer_interp_ba880a-Illustration-1-social.jpg
  preview_image: /assets/images/ufo_hackers_such_as_e2dece_secret_space_fleets_d01cca_ship_transfer_interp_ba880a-Illustration-1.webp
image: /assets/images/ufo_hackers_such_as_e2dece_secret_space_fleets_d01cca_ship_transfer_interp_ba880a-Illustration-1-social.jpg
---

## Introduction

Claims about Gary McKinnon’s alleged discovery of “fleet-to-fleet [transfers]({{ 'transfers/' | relative_url }})” and unfamiliar ship names are often presented as one of the strongest pieces of evidence for a hidden space navy. The logic seems straightforward: if a document records transfers between named vessels that do not appear in public naval registers, perhaps those vessels are spacecraft. The problem is that this conclusion depends on a chain of assumptions that the available evidence does not support.
...
<img src="{{ "/assets/images/ufo_hackers_such_as_e2dece_secret_space_fleets_d01cca_ship_transfer_interp_ba880a-Illustration-3-dark.svg" | relative_url }}" alt="Ship Transfers illustration 3" data-theme-src-dark="{{ "/assets/images/ufo_hackers_such_as_e2dece_secret_space_fleets_d01cca_ship_transfer_interp_ba880a-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/ufo_hackers_such_as_e2dece_secret_space_fleets_d01cca_ship_transfer_interp_ba880a-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Limits of the Inference
...
* Original documents.
* [Independent witnesses]({{ 'witness-check/' | relative_url }}).
