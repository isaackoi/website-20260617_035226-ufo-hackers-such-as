...
show_ads: true
description: A hacked origin makes evidence harder to trust unless every copy, transfer, hash, and handling step can be explained.
hero_summary: A hacked origin makes evidence harder to trust unless every copy, transfer, hash, and handling step can be explained.
layout: default
permalink: /custody/
...
title: Who Held the File Before You Saw It?
title_full: Who Held the File Before You Saw It?
display_title_short: Custody
display_title: Custody
heading_title: Who Held the File Before You Saw It?
page_heading_title: Who Held the File Before You Saw It?
source_count: 60
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Can Metadata Rescue a Hacked UFO Claim?
header:
  og_image: /assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-1-social.jpg
  preview_image: /assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-1.webp
image: /assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-1-social.jpg
---
...
* The [original file]({{ 'original-file/' | relative_url }}).
...
<img src="{{ "/assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-2-dark.svg" | relative_url }}" alt="Custody illustration 2" data-theme-src-dark="{{ "/assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
* Does the metadata fit the claimed date?
* Does the file structure match known software?
* Has the file been edited?
* Does the hash remain consistent?
* Can independent experts reproduce the findings?
...
Once custody is broken, alternative [explanations]({{ 'explanations/' | relative_url }}) multiply.
...
* Complete or partial.
* Edited or untouched.
* Correctly interpreted or misunderstood.
* Associated with the claimed system at all.
...
<img src="{{ "/assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-3-dark.svg" | relative_url }}" alt="Custody illustration 3" data-theme-src-dark="{{ "/assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/ufo_hackers_such_as_e2dece_verify_hacker_eviden_8e99a2_ufo_hacker_chain_cus_393184-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## A Practical Custody Checklist for UFO Claims
...
Verification requires more than a single witness.
7. **Is there corroborating system context?**
Logs, neighbouring files, archived references, or institutional records.
