...
- ufo_hackers_such_as_e2dece_curiosity_hacking_la_1c3ea1_index
...
show_ads: true
description: Curiosity, activism, or UFO belief can explain a hacker's motive without making unauthorized access legal.
hero_summary: Curiosity, activism, or UFO belief can explain a hacker's motive without making unauthorized access legal.
layout: default
permalink: /legal-limits/
sidebar_expanded_urls:
- /ufo-hackers-such/
nav_short_title: Legal Limits
title: When Curiosity Becomes a Computer Crime
title_full: When Curiosity Becomes a Computer Crime
display_title_short: Legal Limits
display_title: Legal Limits
heading_title: When Curiosity Becomes a Computer Crime
page_heading_title: When Curiosity Becomes a Computer Crime
source_count: 129
infographic_count: 3
planned_sections:
- Unauthorized access basics
- Damage and intent
- Why public interest arguments are limited
...
next_link:
  ...
  short_title: Lessons
  heading_title: What Security Teams Can Learn From Mc Kinnon
date: '2026-06-16 23:02:11 '
header:
  og_image: /assets/images/ufo_hackers_such_as_e2dece_curiosity_hacking_la_1c3ea1-overview-social.jpg
  preview_image: /assets/images/ufo_hackers_such_as_e2dece_curiosity_hacking_la_1c3ea1-overview.webp
image: /assets/images/ufo_hackers_such_as_e2dece_curiosity_hacking_la_1c3ea1-overview-social.jpg
---
...
* **Authorised testing** means the system owner has clearly allowed the activity, usually with written scope, limits and reporting rules.
* **Open-source investigation** means using publicly available information without bypassing access controls or entering private systems.
* **Responsible disclosure** means reporting a vulnerability in a way that avoids unnecessary data access, avoids persistence and gives the owner a chance to fix it.
* **Unauthorised intrusion** means accessing systems, accounts, files or networks without permission, even where the motive is curiosity, activism or belief.
* **Aggravated conduct** includes disruption, copying, deletion, concealment, tool installation, credential misuse, threats or targeting sensitive government and critical systems.
...
<img src="{{ "/assets/images/ufo_hackers_such_as_e2dece_curiosity_hacking_la_1c3ea1-Illustration-3-dark.svg" | relative_url }}" alt="Legal Limits illustration 3" data-theme-src-dark="{{ "/assets/images/ufo_hackers_such_as_e2dece_curiosity_hacking_la_1c3ea1-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/ufo_hackers_such_as_e2dece_curiosity_hacking_la_1c3ea1-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
